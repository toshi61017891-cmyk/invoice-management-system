...
import { createQuote, getCustomersForSelect } from "@/app/actions/quotes";
...
export function QuoteForm({ onClose, onSuccess }: QuoteFormProps) {
  ...
  return (
    <Modal isOpen onClose={onClose} title="新規見積を作成" size="lg">
